...
function JoinPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    void navigate({
      to: '/room/$roomId',
      params: { roomId: 'new' },
      search: { name: name.trim(), code: code.trim().toUpperCase() },
    })
  }
    ...
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400">You've been invited to a room</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                maxLength={4}
                className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono text-lg tracking-widest uppercase"
              />
            </div>
